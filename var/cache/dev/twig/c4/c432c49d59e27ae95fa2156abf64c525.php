...
/* error/403.html.twig */
class __TwigTemplate_7fa54c8b85cbb7c7ad3f8c2d7a48f255 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "error/403.html.twig", 1);
...
<div class=\"example-wrapper\">
    ...
    <ul>
        <li>Bilgileriniz</li>
        <li>Bu Sayfaya Giriş yetkiniz yokutur</li>
        <li>Bu Sayfaya Giriş yetkiniz yokutur</li>
        <li>Bu Sayfaya Giriş yetkiniz yokutur</li>
        <li>Bu Sayfaya Giriş yetkiniz yokutur</li>
        <li>Mail Adresiniz:";
...
{% block title %}403 Yetki Hatası{% endblock %}
...
<div class=\"example-wrapper\">
    ...
    <ul>
        ...
        <li>Bu Sayfaya Giriş yetkiniz yokutur</li>
        <li>Bu Sayfaya Giriş yetkiniz yokutur</li>
        <li>Mail Adresiniz:{{app.user.email}}</li>
        
        
    </ul> 
</div>
{% endblock %}
", "error/403.html.twig", "C:\\Users\\Sinem\\Documents\\GitHub\\KutuphaneP\\templates\\error\\403.html.twig");
    }
}
