 ...
 */
class getBorrowedbookRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BorrowedbookRepository' shared autowired service.
     *
     * @return \App\Repository\BorrowedbookRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BorrowedbookRepository.php';

        return $container->privates['App\\Repository\\BorrowedbookRepository'] = new \App\Repository\BorrowedbookRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
